...
class Router
{
    ...
    **/
    ...
    static function genUrl($url = null)
    {
        if(is_null($url))
        {
    ...
    /**
    * Permet de générer une url à partir d'une url originale (avec token)
    * @param $url URL: controller/action(/:param/:param/:param...)
    **/
    static function url($url = null)
    {
        if(isset($_SESSION['token']))
        {
            return self::genUrl($url).'?tk='.$_SESSION['token'];
        }

        return self::genUrl($url);
    }

    /**
    * Permet de générer des URL pour ressources (images, js, css)
    * @param $url URL a générer
    **/
    static function asset($url = null)
    {
        return self::genUrl($url);
    }
